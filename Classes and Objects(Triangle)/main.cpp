...
{
    cout<<"Sides: "<<roundTo(a.getAB(),1)<<", "<<roundTo(a.getAC(),1)<<", "<<roundTo(a.getBC(),1)<<endl;
    cout<<"Angles: a= "<<roundTo(a.getA()*180/M_PI,1)<<" b= "<<roundTo(a.getB()*180/M_PI,1)<<", c= "<<roundTo(a.getC()*180/M_PI,1)<<endl;
